...
# เสิร์ฟหน้าเว็บ login/frontend ตรง ๆ จาก backend ตัวเดียวกัน
# (เข้า URL หลักของ Render แล้วจะเจอหน้านี้ทันที แทนที่จะเจอแค่ JSON)
@app.get("/", tags=["Health"])
def serve_frontend():
    return FileResponse("CookAI_login.html")
